    ...
    <li class="uk-position-relative" v-for="(item, index) in cartItems">
            ...
            <div class="uk-grid-small" uk-grid>
                ...
                <div class="uk-width-auto">
                    ...
                    <a :href="item.product.link">
                        ...
                        <div class="
                            ...
                            " 
                            :style="{'background-image':'url(\'' + item.product.teaserImagePath + '\')', 'width': '45px', 'height': '45px'}"
                        ></div>
                ...
                <div class="uk-width-expand">            
                    ...
                    <ul class="uk-list uk-list-collapse">
                        <li v-if="item.selected_variant" v-for="variant in item.selected_variant">
                            <span class="uk-h6">
                                {{ variant.name }}: 
        ...
        <div class="uk-grid-small uk-visible@s" uk-grid>
            ...
            <div class="uk-width-auto uk-margin-small-right">
                ...
                <div class="uk-h5 uk-margin-remove uk-text-center">
                    <span class="uk-h6 uk-text-small uk-text-muted">X</span> {{item.amount}}
                </div>

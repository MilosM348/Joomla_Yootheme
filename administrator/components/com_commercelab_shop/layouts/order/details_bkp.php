            ...
            <tr>
                ...
                <td>
                    <div class="el-content uk-panel">
                      <span v-show="order.order_paid === 1" @click="togglePaid" style="font-size: 18px; cursor: pointer;">
                          <i class="fas fa-check-circle uk-text-success"></i>
                      </span>
                        <span v-show="order.order_paid === 0" @click="togglePaid" style="font-size: 18px; cursor: pointer;">

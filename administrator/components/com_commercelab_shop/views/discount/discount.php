            ...
            <div class="uk-grid" uk-grid="">
                    ...
                    <div>
                        ...
                        <!-- <nav class="uk-navbar-container uk-padding-small editing-save" uk-navbar style="border-radius: 8px" uk-sticky="offset: 20"> -->
                            ...
                            <div class="uk-navbar-right">
                                ...
                                <a class="uk-button uk-button-default uk-button-small" href="index.php?option=com_commercelab_shop&view=discounts">
                ...
                <div class="uk-width-1-1@s uk-width-1-1@m uk-width-1-1@l uk-width-2-3@xl">
					...
					<?= LayoutHelper::render('card', array(
						'form'      => $vars['form'],
						'cardStyle' => 'default',
						'cardTitle' => 'COM_COMMERCELAB_SHOP_ADD_DISCOUNTS_MODAL_DISCOUNT_DETAILS',
						'cardId'    => 'details',
						'fields'    => array('name', 'discount_type', 'amount', 'percentage', 'coupon_code', 'start_date', 'expiry_date', 'max_usage', 'published')
					)); ?>

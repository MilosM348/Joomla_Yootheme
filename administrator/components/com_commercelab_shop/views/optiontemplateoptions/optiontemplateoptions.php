...
<div id="p2s_productoptions">
    <div class="uk-margin-left">
                        ...
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-expand">
                                <h3>
                                    ...
                                    &nbsp; <?= Text::_('COM_COMMERCELAB_SHOP_OPTIONS_TEMPLATES_LIST'); ?> for <?= $vars['template_name'] ?></h3>
                            </div>
                        ...
                        <table class="uk-table uk-table-striped uk-table-divider uk-table-hover uk-table-responsive  uk-table-middle">
                            ...
                            <th class="uk-text-left">
                                ...
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_OPTIONS_TABLE_NAME'); ?>
                                    <a href="#"  class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left uk-table-expand"><?= Text::_('COM_COMMERCELAB_SHOP_OPTIONS_TEMPLATE_NAME'); ?>
                                    <a href="#"  class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left uk-table-expand"><?= Text::_('COM_COMMERCELAB_SHOP_OPTIONS_TEMPLATES_VALUES'); ?>
                                    <a href="#"  class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                            ...
                            <td>
                                ...
                                <td>
                                    <p-button :label="value" v-for="value in item.values" class="p-button-raised p-button-rounded uk-margin-small-right uk-margin-small-bottom" />
                                </td>
                                <td class="uk-text-right">
                                    <ul class="uk-iconnav uk-flex-nowrap uk-flex uk-flex-middle orderingtable">
                                     
                                        <!-- <li>
                                            <a :href="'index.php?option=com_commercelab_shop&view=optiontemplatevalues&option_id='+ item.id" uk-icon="icon: plus-circle" uk-tooltip="Add Options Values"></a>
                                        </li> -->
                                       
                                        <li>
                                            <a @click="editTemplateOptions(item)"><span uk-icon="icon: pencil"></span></a>
                                        </li>
                                        <li>
            ...
            <!-- <div class="uk-width-2-5">
                <div>
                    <div class="uk-card uk-card-default" uk-sticky="offset: 100">
                        ...
                        <div class="uk-card-body">
                            <?= LayoutHelper::render('optiontemplates.addoption', array(
                                'items' => $items
                            )); ?>  
                        </div>
                    </div>
                    ...
                    <div class="uk-card uk-card-default" uk-sticky="offset: 100">
                        ...
                        <div class="uk-card-body">
                            <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
                                ...
                                <li>
                                    <a @click="addOptionTemplateOptions">
                                    <span class="uk-margin-small-right" uk-icon="icon: plus-circle"></span>
                                        <?= Text::_('Add Option'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="index.php?option=com_commercelab_shop&view=optiontemplates">
                                    <span class="uk-margin-small-right" uk-icon="icon: reply"></span>
                                        <?= Text::_('COM_COMMERCELAB_SHOP_BACK_TO_OPTION_TEMPLATES'); ?>
                                    </a>
                                </li>
        ...
        <?= LayoutHelper::render('optiontemplates.editoptiontemplatemodal', array(
            'items' => $items
        )); ?> 
		...
		util.ready(function () {
			...
			util.on('.mainitems', 'stop', function (e, sortable, el) { 
                ...
                const params = {'items': newItemList,};
						...
						const request = fetch(base_urls + "index.php?option=com_ajax&plugin=commercelab_shop_ajaxhelper&method=post&task=task&type=optiontemplates.optiontemplatesoptionordering&format=raw", {
							method: 'POST',
							mode: 'cors',
							cache: 'no-cache',

...
<div id="p2s_order_form" v-cloak class="uk-animation-fade">
            ...
            <div class="uk-width-1-1@m uk-width-1-1@l uk-width-1-1@xl">
                ...
                <ul class="uk-switcher uk-margin">
                    ...
                    <li>
                        <div class="uk-grid" uk-grid="">
                            <div class="uk-width-1-1@l">
								<?php // LayoutHelper::render('order.emailactions', array(
									// 'item'      => $item,
									// 'cardStyle' => 'default',
                ...
                <div class="uk-card uk-card-default uk-margin-medium-top">
                    ...
                    <div class="uk-card-body">
                        <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
                            ...
                            <li>
                                <a href="javascript:void(0);" @click="togglePaid()">
                                    <span class="uk-margin-small-right">
                                        <i class="fas fa-money-bill-wave"></i>
                                    </span>
                                    <span v-if="order.order_paid == '1'">
                                        <?= Text::_('COM_COMMERCELAB_SHOP_ORDER_MARK_AS_UNPAID'); ?>        
                                    </span>
                                    <span v-else>
                                        <?= Text::_('COM_COMMERCELAB_SHOP_ORDER_MARK_AS_PAID'); ?>        
                                    </span>
                                </a>
                            </li>
                                ...
                                <div uk-dropdown="mode: click">
                                    ...
                                    <div class="uk-grid" uk-grid="">
                                        ...
                                        <div class="uk-width-auto">
                                            <span class="uk-text-meta">Send email also?</span>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="uk-list uk-dropdown-nav">
                                        ...
                                        <li>
                                            <button @click="changeStatus('P')"
                                                :class="{'uk-disabled uk-text-muted': order.order_status == 'P'}"
                                                class="uk-button uk-button-default uk-button-small uk-width-1-1"
                                                href="#"><?= Text::_('COM_COMMERCELAB_SHOP_ORDER_PENDING'); ?>        
                                            </button>
                                        </li>
                                        <li>
                                            <button @click="changeStatus('C')"
                                                :class="{'uk-disabled uk-text-muted': order.order_status == 'C'}"
                                                class="uk-button uk-button-default uk-button-small uk-width-1-1"
                                                href="#"><?= Text::_('COM_COMMERCELAB_SHOP_ORDER_CONFIRMED'); ?>        
                                            </button>
                                        </li>
                                        <li>
                                            <button @click="changeStatus('X')"
                                                :class="{'uk-disabled uk-text-muted': order.order_status == 'X'}"
                                                class="uk-button uk-button-default uk-button-small uk-width-1-1"
                                                href="#"><?= Text::_('COM_COMMERCELAB_SHOP_ORDER_CANCELLED'); ?>        
                                            </button>
                                        </li>
                                        <li>
                                            <button @click="changeStatus('R')"
                                                :class="{'uk-disabled uk-text-muted': order.order_status == 'R'}"
                                                class="uk-button uk-button-default uk-button-small uk-width-1-1"
                                                href="#"><?= Text::_('COM_COMMERCELAB_SHOP_ORDER_REFUNDED'); ?>        
                                            </button>
                                        </li>
                                        <li>
                                            <button @click="changeStatus('S')"
                                                :class="{'uk-disabled uk-text-muted': order.order_status == 'S'}"
                                                class="uk-button uk-button-default uk-button-small uk-width-1-1"
                                                href="#"><?= Text::_('COM_COMMERCELAB_SHOP_ORDER_SHIPPED'); ?>        
                                            </button>
                                        </li>
                                        <li>
                                            <button @click="changeStatus('F')"
                                                :class="{'uk-disabled uk-text-muted': order.order_status == 'F'}"
                                                class="uk-button uk-button-default uk-button-small uk-width-1-1"
                                                href="#"><?= Text::_('COM_COMMERCELAB_SHOP_ORDER_COMPLETED'); ?>        
                                            </button>
                                        </li>
                                        <li>
                                            <button @click="changeStatus('D')"
                                                :class="{'uk-disabled uk-text-muted': order.order_status == 'D'}"
                                                class="uk-button uk-button-default uk-button-small uk-width-1-1"
                                                href="#"><?= Text::_('COM_COMMERCELAB_SHOP_ORDER_DENIED'); ?>        
                                            </button>
                                        </li>
                            ...
                            <li>
                                <a href="#shipmodal" uk-toggle>
                                    <span class="uk-margin-small-right"><i class="fas fa-shipping-fast"></i></span>
                                    Ship
                                </a>

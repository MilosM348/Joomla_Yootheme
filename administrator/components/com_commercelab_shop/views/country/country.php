            ...
            <div class="uk-grid" uk-grid="">
                        ...
                        <!-- <nav class="uk-navbar-container uk-padding-small editing-save" uk-navbar style="border-radius: 8px" uk-sticky="offset: 20"> -->
                            ...
                            <div class="uk-navbar-left">
                                ...
                                <span class="uk-navbar-item uk-logo">
                                        ...
                                        <?= Text::_('COM_COMMERCELAB_SHOP_COUNTRY'); ?>: {{form.jform_country_name}}
                            ...
                            <div class="uk-navbar-right">
                                ...
                                <a class="uk-button uk-button-default uk-button-small"
                                   href="index.php?option=com_commercelab_shop&view=countries"><?= Text::_('JTOOLBAR_CANCEL'); ?></a>
                ...
                <div class="uk-width-1-1@s uk-width-1-1@m uk-width-1-1@l uk-width-2-3@xl">
                    ...
                    <?= LayoutHelper::render('card', array(
                        'form'      => $vars['form'],
                        'cardStyle' => 'default',
                        'cardTitle' => 'COM_COMMERCELAB_SHOP_COUNTRY_DETAILS',
                        'cardId'    => 'details',
                        'fields'    => array('country_name', 'country_isocode_2', 'country_isocode_3', 'taxrate', 'taxrate_reduced', 'taxrate_extra', 'requires_vat', 'published')
                    )); ?>

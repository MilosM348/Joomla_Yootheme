        ...
        <div class="uk-grid center-section" uk-grid="">
            <div class="uk-width-1-1@m uk-width-1-1@l uk-width-1-1@xl">
                <div class="uk-card uk-card-default">
                        ...
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-1-1@s uk-width-1-1@m uk-width-1-2@l uk-width-2-3@xl uk-margin-small-bottom">
                                <h3>
									...
									<?= Text::_('COM_COMMERCELAB_SHOP_SHIPPINGRATES_TITLE'); ?>
                                </h3>
                            </div>
                    ...
                    <table class="uk-table uk-table-striped uk-table-divider uk-table-hover uk-table-middle">
                            <thead>
                            <tr>
                                ...
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_SHIPPINGRATES_TABLE_COUNTRYNAME'); ?>
                                    <a href="#" @click="sort('country_name')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_SHIPPINGRATES_TABLE_WEIGHT_FROM'); ?>
                                    <a href="#" @click="sort('weight_from')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>

                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_SHIPPINGRATES_TABLE_WEIGHT_TO'); ?>
                                    <a href="#" @click="sort('weight_to')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_SHIPPINGRATES_TABLE_COST'); ?>
                                    <a href="#" @click="sort('cost')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_SHIPPINGRATES_TABLE_HANDLING_COST'); ?>
                        ...
                        <h5 v-show="itemsChunked.length == 0"><?= Text::_('COM_COMMERCELAB_SHOP_COUNTY_SHIPPING_RATES_EMPTY_TABLE'); ?></h5>
                    ...
                    <div class="uk-card uk-card-default ">
                        ...
                        <div class="uk-card-body">
                            <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
                                ...
                                <li>
                                    <a class="uk-text-emphasis" href="index.php?option=com_commercelab_shop&view=shippingratescountry">

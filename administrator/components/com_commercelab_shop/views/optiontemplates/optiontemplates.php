...
<div id="p2s_productoptions">
                        ...
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-expand">
                                <h3>
                                    ...
                                    &nbsp; <?= Text::_('COM_COMMERCELAB_SHOP_OPTIONS_TEMPLATES_TITLE'); ?></h3>
                            </div>
                    ...
                    <div class="uk-card-body">
                        ...
                        <table class="uk-table uk-table-striped uk-table-divider uk-table-hover uk-table-responsive  uk-table-middle">
                            ...
                            <tr  class="el-item " v-for="item in itemsChunked[currentPage]" :id="item.id">
                                ...
                                <td>
                                    <div v-if="item.option_type == 'variant_option'">Variant</div>
                                    <div v-if="item.option_type == 'checkbox_option'">Checkbox</div>
                                </td>
                                <td class="uk-text-right">
                                    <ul class="uk-iconnav">
                                        
                                         <li v-if="item.option_type=='variant_option'">
                                            <a :href="'index.php?option=com_commercelab_shop&view=optiontemplateoptions&template_id='+ item.id" uk-icon="icon: plus-circle" uk-tooltip="Add Options"></a>
                                        </li>
                                        <li>
                                            <a @click="editOptionTemplate(item)"><span uk-icon="icon: pencil"></span></a>
                                        </li>
                                        <!-- <li>
                    ...
                    <div class="uk-card uk-card-default" uk-sticky="offset: 100">
                        ...
                        <div class="uk-card-body">
                            <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
                                ...
                                <li>
                                    <a @click="addProductOptionTemplate('variant_option')">
                                    <span class="uk-margin-small-right" uk-icon="icon: plus-circle"></span>
                                        <?= Text::_('COM_COMMERCELAB_SHOP_OPTIONS_TEMPLATES_PRODUCT_VARIANT_TITLE'); ?>
                                    </a>
                                </li>
                                <li class="uk-nav-divider"></li>
                                <li>
                                    <a @click="addProductOptionTemplate('checkbox_option')">
                                        <span class="uk-margin-small-right" uk-icon="icon: plus-circle"></span>
										<?= Text::_('COM_COMMERCELAB_SHOP_OPTIONS_TEMPLATES_PRODUCT_CHECKBOX_OPTION_TITLE'); ?>
                                    </a>
                                </li>
    ...
    <?= LayoutHelper::render('optiontemplates.optiontemplatemodal', array(
		'items' => $items
	)); ?>
</div>
<script>
		...
		util.ready(function () {
			...
			util.on('.mainitems', 'stop', function (e, sortable, el) { 
                ...
                const params = {'items': newItemList,};
						...
						const request = fetch(base_urls + "index.php?option=com_ajax&plugin=commercelab_shop_ajaxhelper&method=post&task=task&type=optiontemplates.optiontemplatesordering&format=raw", {
							method: 'POST',
							mode: 'cors',
							cache: 'no-cache',

...
<div id="p2s_zones" v-cloak>
                       ...
                       <div class="uk-grid  uk-grid-small"> <!-- ADD LINE -->
                            <div class="uk-width-1-1@s uk-width-1-1@m uk-width-1-1@l uk-width-1-2@xl">
                                <h3>
                                    ...
                                    &nbsp
									<?= Text::_('COM_COMMERCELAB_SHOP_ZONES_TITLE'); ?>
                                </h3>
                            </div>
                    ...
                    <div class="uk-card-body uk-overflow-auto">
                        ...
                        <table class="uk-table uk-table-striped uk-table-divider uk-table-hover uk-table-responsive  uk-table-middle">
                            ...
                            <tr>
                                ...
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_ZONES_TABLE_ZONENAME'); ?>
                                    <a href="#" @click="sort('zone_name')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_ZONES_TABLE_COUNTRYNAME'); ?>
                                    <a href="#" @click="sort('country_name')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_ZONES_TABLE_ISO'); ?>
                                    <a href="#" @click="sort('zone_isocode')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>

                                <th class="uk-text-left"><?= Text::_('Inherit Taxrate'); ?>
                                    <a href="#" @click="sort('inherit_taxrate')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>

                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_ZONES_TAXRATE'); ?>
                                ...
                                <th class="uk-text-left"><?= Text::_('COM_COMMERCELAB_SHOP_ZONES_TABLE_PUBLISHED'); ?>
                            ...
                            <tr class="el-item" v-for="item in itemsChunked[currentPage]">
                                ...
                                <td>
                                    <a :href="'index.php?option=com_commercelab_shop&view=zone&id=' + item.id"> {{item.zone_name}}</a>
                                </td>
                                <td>
                                    {{item.country_name}}
                                </td>
                                ...
                                <td class="uk-text-center">
                                    <span v-if="item.inherit_taxrate == '1'"
                                        style="font-size: 18px; color: green; cursor: pointer;">
                                            <i class="fas fa-check-circle"></i>
                                    </span>
                                    <span v-if="item.inherit_taxrate == '0'"
                                        style="font-size: 18px; color: red; cursor: pointer;">
                                            <i class="fas fa-times-circle"></i>
                                    </span>
                                </td>

                                <td class="uk-text-center" v-if="item.inherit_taxrate == '1'">
                                    {{ countries[item.country_id].taxrate }}
                                </td>
                                <td class="uk-text-center" v-else>
                                    {{item.taxrate}}
                                </td>

                                <td class="uk-text-center" v-if="item.inherit_taxrate == '1'">
                                    {{ countries[item.country_id].taxrate_reduced }}
                                </td>
                                <td class="uk-text-center" v-else>
                                ...
                                <td class="uk-text-center" v-if="item.inherit_taxrate == '1'">
                                    {{ countries[item.country_id].taxrate_extra }}
                                </td>
                                <td class="uk-text-center" v-else>
                                    {{item.taxrate_extra}}
                                </td>
    ...
    <div class="right-bar">
                ...
                <div class="uk-alert-primary" uk-alert>
		            <?= Text::_('COM_COMMERCELAB_SHOP_ZONES_NOTICE_INFO'); ?>
                </div>
            </div>

...
const p2s_emailmanager = {
    ...
    methods: {
        ...
        async trashSelected() {
            ...
            const response = await this.makeACall(params , '&type=email.trash');
        ...
        async toggleSelected() {
            ...
            const response = await this.makeACall(params , '&type=email.togglePublished');
        ...
        async updateList() {
            ...
            const response = await this.makeACall({}, '&type=email.updatelist');
        ...
        async filter() {
            ...
            const response = await this.makeACall(params , '&type=email.filter');

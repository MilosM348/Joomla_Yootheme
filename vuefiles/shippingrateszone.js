...
const p2s_shippingrateszone_form = {
    data() {
        return {
            base_url: '',
            form: {
    ...
    methods: {
        ...
        async saveItem() {
            ...
            const params = {
                ...
                zone_id: this.form.jform_zone_id,
            ...
            const request = await fetch("index.php?option=com_ajax&plugin=commercelab_shop_ajaxhelper&method=post&task=task&type=shippingrateszone.save&format=raw", {
                method: 'POST',
                mode: 'cors',
                cache: 'no-cache',
            ...
            if (response.success) {
                ...
                if (this.andClose) {
                    ...
                    window.location.href = 'index.php?option=com_commercelab_shop&view=shippingrateszones';
                } else {
...
Vue.createApp(p2s_shippingrateszone_form).mount('#p2s_shippingrateszone_form');
...
const p2s_shippingratescountry = {
    ...
    methods: {
        ...
        async save(item) {
           ...
           const request = await fetch("index.php?option=com_ajax&plugin=commercelab_shop_ajaxhelper&method=post&task=task&type=shippingratescountry.save&format=raw&" + URLparams, {
               method: 'post',
               mode: 'cors',
               cache: 'no-cache',
               credentials: 'same-origin',
        ...
        async trashSelected() {
            ...
            const response = await this.makeACall(params, '&type=shippingratescountry.trash');
        ...
        async toggleSelected() {
            ...
            const response = await this.makeACall(params, '&type=shippingratescountry.togglePublished');
        ...
        async filter() {
            ...
            const response = await this.makeACall(params, '&type=shippingratescountry.filter');

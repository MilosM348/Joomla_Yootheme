...
class plgSystemCommercelab_shop_stripepayment extends CMSPlugin
{
	...
	public function onAfterInitialise()
	{
		...
		$loader->setPsr4("YpsApp_stripepayment\\", __DIR__ . "/modules/stripepayment");

		// set alias
		Path::setAlias('~commercelab_shop_stripepayment', $root);
		Path::setAlias('~commercelab_shop_stripepayment:rel', $rootUrl . '/plugins/system/commercelab_shop_stripepayment');

		// bootstrap modules
		$app->load('~commercelab_shop_stripepayment/modules/stripepayment/bootstrap.php');
	...
	private function getExtensionData()
	{
		...
		$query->where($this->db->quoteName('element') . ' = ' . $this->db->quote('pkg_commercelab_shop_stripepayment'));
